...
$sql = "SELECT id, name FROM courses WHERE teacher_id = $user_id";
...
<body>
    ...
    <div class="container mt-5">
        <a href="teacher_assess.php"><button class="btn btn-primary">Assess Student</button></a>
        <br><br>
        <h4>Edit Courses Details</h4>
        <div class="list-group">
            <?php while ($row = $result->fetch_assoc()): ?>
                <a href="teacher_course_details.php?course_id=<?php echo $row['id'];?>" class="list-group-item list-group-item-action">
